...
extern int e1000e_open(struct net_device *netdev);
extern int e1000e_close(struct net_device *netdev);
...
extern s32 __ew32_prepare(struct e1000_hw *hw);
extern void __ew32(struct e1000_hw *hw, unsigned long reg, u32 val);
...
extern IOLock* swflag_mutex;

const struct e1000_info* e1000_probe( u16 );
#endif
